...
<html>
  <head>
    ...
    <script type="text/javascript" src="css/ajax3.3.js"></script>
    <script type="text/javascript" src="css/ajax2.1.js"></script>
    <script type="text/javascript" src="css/instascan12.js"></script>
      ...
      <div class="sidebar">
        ...
        <section class="scans">
          ...
          <li v-for="scan in scans" :key="scan.date" :title="scan.content">{{ scan.content }}
            <form action="qr-action.php" method="get">
