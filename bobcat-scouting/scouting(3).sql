...
CREATE TABLE `sdata` (
  ...
  `c4a` varchar(255) DEFAULT NULL,
  `baa` varchar(255) DEFAULT NULL,
  `paa` varchar(255) DEFAULT NULL,
  `daa`varchar(255) DEFAULT NULL,
  `af` varchar(255) DEFAULT NULL,

  `dat` varchar(255) DEFAULT NULL,
  `pl` varchar(255) DEFAULT NULL,
  `c1t` varchar(255) DEFAULT NULL,
  `c2t` varchar(255) DEFAULT NULL,
  `c3t` varchar(255) DEFAULT NULL,
  `c4t` varchar(255) DEFAULT NULL,
  `bat` varchar(255) DEFAULT NULL,
  `pat` varchar(255) DEFAULT NULL,

  `tf` varchar(255) DEFAULT NULL,
  `cf` varchar(255) DEFAULT NULL,
  `tfell` varchar(255) DEFAULT NULL,
  `toc` varchar(255) DEFAULT NULL,
  `ep` varchar(255) DEFAULT NULL,
  `def` varchar(255) DEFAULT NULL,
  `ofs` varchar(255) DEFAULT NULL,
  `dfs` varchar(1500) DEFAULT NULL,
  `cs` varchar(1500) DEFAULT NULL,
  `cm` varchar(1500) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
